...
public class WebSiteInfoBOImpl implements WebSiteInfoBO {
    ...
    @Override
    public WebSiteInfo getInfo(long id) throws DataAccessException {
        return this.webSiteInfoRepository.findById(id).get();
    }
    ...
    public void deleteWebSiteInfo(long id) throws DataAccessException {
        this.webSiteInfoRepository.deleteById(id);
    }
